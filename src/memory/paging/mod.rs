...
impl ActivePageTable {
        ...
        where F: FnOnce(&mut Mapper)
    {
...

        {
            ...
            // map temporary_page to current page
    ...
    pub fn switch(&mut self, new_table: InactivePageTable) ->
        InactivePageTable
    {
...
{
    print!("testing paging subsystem");
    let mut page_table = unsafe { ActivePageTable::new() };
    let addr = 42 * 512 * 512 * 4096; // 42 P3 entry
    ...
    where A: FrameAllocator
{
    ...
    active_table.with(&mut new_table, &mut temporary_page, |mapper| {
        ...
        for section in elf_sections_tag.sections() {
            ...
            println!("mapping sections at addr: {:#x}, size: {:#x}",
    ...
    println!("loaded newly mapped kernel");
